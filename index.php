		...
		<div class="sfooter-content">
			...
			<section>
				<div class="container">
					...
					<!-- WELCOME IMAGE -->
					<img src="images/welcome.gif" alt="welcome to my homepage" class="welcomepic">
					...
					<div class="instructions-wrapper">
						...
						<img src="images/captain-janeway.png" alt="captain janeway" height="25%" width="25%"/>
			...
			<section class="about-me">
				<div class="container">
					<img src="images/stunning.jpg" alt="captain picard" height="25%" width="25%"/>
